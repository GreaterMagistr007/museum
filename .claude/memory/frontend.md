...
- `modals.blade.php` — overlay + 3 template: tpl-schedule, tpl-location (Яндекс.Карты), tpl-contacts. Кнопка «О музее» на главной — обычная ссылка на route('about'), модалки нет.
